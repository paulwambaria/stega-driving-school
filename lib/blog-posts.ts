...
export const blogPosts: BlogPost[] = [
  ...
  /* ── POST 7 ─────────────────────────────────────────────────────────── */
  {
    slug: "speed-cameras-nairobi-2025-waze-locations",
    title: "Nairobi Speed Camera Locations 2025 — Full Map, Speed Limits & Waze Tips",
    excerpt:
      "Know exactly where every speed camera in Nairobi is, what speed limit applies, and how to use Waze to get real-time alerts. Updated June 2025 with all fixed and mobile camera zones.",
    date: "2025-06-29",
    updated: "2025-06-29",
    readTime: 8,
    category: "Road Rules",
    ...
    keywords: [
      ...
      "waze speed camera kenya",
      "ntsa speed camera",
      "speed limits kenya roads",
      "thika road speed camera",
      "mombasa road camera",
      "nairobi expressway speed limit",
      "kenya speeding fines 2025",
      "radar camera nairobi",
    ],
    toc: [
      { id: "where-are-cameras", title: "Where Are Nairobi's Speed Cameras?" },
      { id: "thika-road-cameras", title: "Thika Superhighway (A2) Cameras" },
      { id: "mombasa-road-cameras", title: "Mombasa Road (A104) Cameras" },
      { id: "other-roads-cameras", title: "Waiyaki Way, Langata & Other Roads" },
      { id: "expressway-cameras", title: "Nairobi Expressway (M27) Cameras" },
      { id: "bypasses-cameras", title: "Eastern, Southern & Northern Bypass Cameras" },
      { id: "mobile-cameras", title: "Mobile Speed Camera Hotspots" },
      { id: "speed-limits-table", title: "Kenya Speed Limits by Road Type" },
      { id: "ntsa-fines", title: "NTSA Speeding Fines 2025" },
      { id: "waze-guide", title: "How to Use Waze for Speed Camera Alerts" },
      { id: "driving-tips", title: "Safe Driving Tips Near Cameras" },
    ],
    content: [
      {
        type: "callout",
        title: "Important",
        text: "Speed cameras in Nairobi are operated by NTSA and the National Police Service. Fines range from KSh 10,000 to KSh 30,000+ per offence. This guide covers all known fixed and mobile camera zones as of June 2025.",
        color: "red",
      },
      { type: "h2", text: "Where Are Nairobi's Speed Cameras?", id: "where-are-cameras" },
      {
        type: "p",
        text: "Nairobi has both fixed (permanently mounted) and mobile (patrol vehicle) speed cameras deployed across major roads. Fixed cameras are installed on poles or gantries and photograph vehicles 24/7. Mobile units are used by traffic police in unmarked vehicles, particularly at known accident blackspots.",
      },
      {
        type: "keypoints",
        title: "Quick Facts — Nairobi Speed Cameras 2025",
        points: [
      ...
      { type: "h2", text: "Thika Superhighway (A2) Speed Camera Locations", id: "thika-road-cameras" },
      {
        type: "p",
        text: "The A2 Thika Superhighway is Nairobi's most camera-dense road. The highway speed limit is 100 km/h on open sections and 80 km/h near interchanges. Fixed cameras are located at:",
      },
      {
        type: "ul",
        items: [
      ...
      {
        type: "tip",
        title: "Thika Road Tip",
        text: "Thika Road cameras are most active in both directions during morning (6–9 AM) and evening (4–8 PM) rush hours. Waze users frequently report flash activity near Garden City and Roysambu.",
      },
      { type: "h2", text: "Mombasa Road (A104) Speed Camera Locations", id: "mombasa-road-cameras" },
      {
        type: "p",
        text: "Mombasa Road carries heavy commercial traffic toward JKIA and is a major NTSA enforcement corridor. Speed limit is 80 km/h on urban sections and 100 km/h on open highway beyond Athi River. Fixed camera hotspots:",
      },
      {
        type: "ul",
        items: [
      ...
      { type: "h2", text: "Waiyaki Way, Ngong Road, Langata Road & Uhuru Highway", id: "other-roads-cameras" },
      {
        type: "table",
        headers: ["Road", "Section / Landmark", "Speed Limit", "Camera Type"],
        rows: [
      ...
      { type: "h2", text: "Nairobi Expressway (M27) Speed Camera Locations", id: "expressway-cameras" },
      {
        type: "p",
        text: "The Nairobi Expressway has a posted speed limit of 110 km/h on open sections and 80 km/h near toll plazas and ramps. It is one of the most heavily monitored roads in Kenya — cameras are built into the toll-monitoring infrastructure.",
      },
      {
        type: "ul",
        items: [
      ...
      {
        type: "warning",
        title: "Expressway Warning",
        text: "The Expressway's cameras are integrated with toll transponders and are active 24 hours a day, 7 days a week. Do not exceed 110 km/h under any circumstances on this road.",
      },
      { type: "h2", text: "Eastern, Southern & Northern Bypass Speed Cameras", id: "bypasses-cameras" },
      {
        type: "ul",
        items: [
      ...
      { type: "h2", text: "Mobile Speed Camera Hotspots in Nairobi", id: "mobile-cameras" },
      {
        type: "p",
        text: "Mobile cameras are the hardest to predict — they move daily. However, Nairobi traffic police have consistent favourite locations for mobile enforcement:",
      },
      {
        type: "ul",
        items: [
      ...
      },
      {
        type: "tip",
        title: "Use Waze",
        text: "Waze is your best tool for real-time mobile camera positions. Nairobi has one of the most active Waze communities in East Africa — camera reports are typically posted within minutes of police deploying.",
      },
      { type: "h2", text: "Kenya Speed Limits by Road Type — 2025", id: "speed-limits-table" },
      {
        type: "table",
        headers: ["Road Type", "Speed Limit", "Examples"],
        rows: [
      ...
      { type: "h2", text: "NTSA Speeding Fines in Kenya — 2025 Schedule", id: "ntsa-fines" },
      {
        type: "p",
        text: "NTSA speeding penalties are set under the Traffic Act and the National Transport and Safety Authority Act. Fines are issued to the registered vehicle owner. Repeated offences can result in licence suspension.",
      },
      {
        type: "table",
        headers: ["Offence", "Fine (KSh)", "Additional Penalty"],
        rows: [
      ...
      },
      {
        ...
        text: "Under Kenya's demerit points system, accumulating 12 points within 12 months results in automatic licence suspension. Serious speeding offences (30+ km/h over limit) attract 6 points per offence.",
      },
      { type: "h2", text: "How to Use Waze for Speed Camera Alerts in Nairobi", id: "waze-guide" },
      {
        type: "p",
        text: "Waze is the most effective tool for avoiding speed cameras in Nairobi. Here is how to set it up correctly:",
      },
      {
        type: "ol",
        items: [
          "Download Waze from Google Play or the App Store — it's free",
          "Create an account (or sign in with Google/Facebook)",
          "Tap the magnifying glass and search your destination — Waze will route you and show real-time alerts",
          "In Settings > Alerts & Reports, enable: Speed Cameras, Police, Hazards, and Traffic Jams",
          "When you see a camera icon on your route, Waze shows the camera location 300–500m in advance with an audio alert",
          "Tap the camera icon to confirm it is still active — this helps the community and improves accuracy",
          "Report cameras you spot yourself by tapping the orange + button > Report > Camera",
          "Join Nairobi-specific Waze groups on WhatsApp and Telegram — these share real-time police and camera positions",
        ],
      },
      {
        type: "tip",
        title: "Waze Setup Tip",
        text: "Set Waze to 'Kenya English' voice so speed alerts are in km/h. Also enable 'Speedometer' in Settings > Display > Vehicle so you always see your live speed on screen.",
      },
      {
        type: "h3",
        text: "Other Apps for Camera Alerts in Nairobi",
      },
      {
        type: "ul",
        items: [
      ...
      { type: "h2", text: "Safe Driving Tips Near Speed Cameras", id: "driving-tips" },
      {
        type: "p",
        text: "The purpose of speed cameras is to save lives — not to generate revenue. Here is how to drive safely and legally on Nairobi roads:",
      },
      {
        type: "ul",
        items: [
    ...
    faqs: [
      {
        q: "Where are speed cameras located in Nairobi in 2025?",
        a: "Major fixed speed camera locations in Nairobi include: Thika Superhighway at Muthaiga, Roysambu, and Githurai interchanges (80 km/h); Mombasa Road at Nyayo Stadium and JKIA approaches (80 km/h); Nairobi Expressway at all interchanges (80 km/h, highway 110 km/h); Waiyaki Way at Westlands interchange (80 km/h); and Ngong Road near Junction Mall (50 km/h). Mobile units operate citywide — use Waze for real-time locations.",
      },
      {
        q: "What is the speed limit on Thika Road in Nairobi?",
        a: "Thika Superhighway (A2) has a speed limit of 80 km/h on most urban sections through Nairobi, reducing to 60 km/h at interchanges and near school zones. The open highway beyond Ruiru allows 100 km/h. Multiple fixed cameras enforce 80 km/h at Muthaiga, Garden City, Roysambu, and Githurai.",
      },
      {
        q: "What is the speed limit on the Nairobi Expressway?",
        a: "The Nairobi Expressway (M27) has a maximum speed limit of 110 km/h on open sections. Speed limits reduce to 80 km/h near interchanges and ramps, and 60 km/h at toll plazas. Speed cameras are integrated at all interchanges and are active 24/7.",
      },
      {
        q: "How much is a speeding fine in Kenya in 2025?",
        a: "NTSA speeding fines in Kenya for 2025: KSh 10,000 for exceeding the limit by 1–10 km/h; KSh 20,000 for 11–20 km/h over; KSh 30,000 for 21–30 km/h over. Speeding in school zones or causing accidents can result in court appearances and licence suspension. Fines are payable via eCitizen.",
      },
      {
        q: "Does Waze show speed cameras in Nairobi?",
        a: "Yes. Waze shows both fixed speed cameras (permanently mapped) and real-time user-reported mobile camera positions across Nairobi. Nairobi has one of East Africa's most active Waze communities. Enable 'Speed Cameras' and 'Police' alerts in Waze Settings to receive audio warnings 300–500m before each camera.",
      },
      {
        q: "What speed should I drive at on Mombasa Road in Nairobi?",
        a: "On Mombasa Road (A104) through Nairobi, the speed limit is 80 km/h on most sections, dropping to 60 km/h near junctions and JKIA. Always watch for the posted signs — limits change at interchanges. Fixed cameras are operational at Nyayo Stadium, South C, and Wilson Airport junctions.",
      },
      {
        q: "How do I pay an NTSA speeding fine in Kenya?",
        a: "NTSA speeding fines are paid via eCitizen (ecitizen.go.ke) under 'NTSA Services'. You can also pay at any NTSA huduma centre. Fines must be paid within 14 days to avoid additional penalties. You will need your ID number and vehicle registration number. M-Pesa payments are accepted through eCitizen.",
      },
    ],
  },
];

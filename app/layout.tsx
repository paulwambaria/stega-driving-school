...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description: "NTSA-approved driving courses — Manual, Automatic, Motorcycle, PSV & Truck",
      url: `${BASE_URL}/courses`,
    },
    {
      "@type": "SiteNavigationElement",
      "@id": `${BASE_URL}/#nav-branches`,
      name: "Our Branches",
      description: "5 branches across Nairobi — CBD, Jevanjee, Embakasi, Savannah & Kayole",
      url: `${BASE_URL}/contact`,
    },
    {
      "@type": "SiteNavigationElement",
      "@id": `${BASE_URL}/#nav-book`,
      name: "Book a Course",
      description: "Register online for any NTSA-approved driving course",
      url: `${BASE_URL}/book`,
    },
    {
      "@type": "SiteNavigationElement",
      ...
      name: "About Us",
      description: "Kenya's trusted NTSA-approved driving school since 1995",
      url: `${BASE_URL}/about`,
    },
    {
      "@type": "SiteNavigationElement",
      "@id": `${BASE_URL}/#nav-blog`,
      name: "Blog & Road Safety Guides",
      description: "NTSA rules, driving tips, road signs & Kenya road safety articles",
      url: `${BASE_URL}/blog`,
    },
    {
      "@type": "SiteNavigationElement",
      "@id": `${BASE_URL}/#nav-contact`,
      name: "Contact Us",
      description: "Contact Stega Driving School — call, WhatsApp or visit any branch",
      url: `${BASE_URL}/contact`,
    },
    {
      "@type": "ItemList",
      "@id": `${BASE_URL}/#sitepages`,
      name: "Stega Driving School — Main Pages",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Driving Courses", url: `${BASE_URL}/courses` },
        { "@type": "ListItem", position: 2, name: "Our Branches", url: `${BASE_URL}/contact` },
        { "@type": "ListItem", position: 3, name: "Book a Course", url: `${BASE_URL}/book` },
        { "@type": "ListItem", position: 4, name: "About Us", url: `${BASE_URL}/about` },
        { "@type": "ListItem", position: 5, name: "Blog & Road Safety", url: `${BASE_URL}/blog` },
